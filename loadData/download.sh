...
lar_2023_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/snapshot-data/2023/2023_public_lar_pipe.zip"
lar_2022_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/one-year-data/2022/2022_public_lar_one_year_pipe.zip"
lar_2021_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/one-year-data/2021/2021_public_lar_one_year_pipe.zip"
lar_2020_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/three-year-data/2020/2020_public_lar_three_year_pipe.zip"
...
declare -a lar_url_list=(${lar_2018_url} ${lar_2019_url} ${lar_2020_url} ${lar_2021_url} ${lar_2022_url} ${lar_2023_url})

#TS URL list for data downloading
ts_2023_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/snapshot-data/2023/2023_public_ts_pipe.zip"
ts_2022_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/one-year-data/2022/2022_public_ts_one_year_pipe.zip"
ts_2021_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/one-year-data/2021/2021_public_ts_one_year_pipe.zip"
ts_2020_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/three-year-data/2020/2020_public_ts_three_year_pipe.zip"
...
#store download URLs in list for later iteration
#declare -a ts_url_list=(${ts_2004_url} ${ts_2005_url} ${ts_2006_url} ${ts_2007_url} ${ts_2008_url} ${ts_2009_url} ${ts_2010_url} ${ts_2011_url} ${ts_2012_url} ${ts_2013_url} ${ts_2014_url} ${ts_2015_url} ${ts_2016_url} ${ts_2017_url} ${ts_2018_url} ${ts_2019_url} ${ts_2020_url} ${ts_2021_url} ${ts_2022_url})
declare -a ts_url_list=(${ts_2018_url} ${ts_2019_url} ${ts_2020_url} ${ts_2021_url} ${ts_2022_url} ${ts_2023_url})

#Panel URL list for data downloading
panel_2023_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/snapshot-data/2023/2023_public_panel_pipe.zip"
panel_2022_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/one-year-data/2022/2022_public_panel_one_year_pipe.zip"
panel_2021_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/one-year-data/2021/2021_public_panel_one_year_pipe.zip"
panel_2020_url="https://s3.amazonaws.com/cfpb-hmda-public/prod/three-year-data/2020/2020_public_panel_three_year_pipe.zip"
...
#store download URLs in list for later iteration
#declare -a panel_url_list=(${panel_2004_url} ${panel_2005_url} ${panel_2006_url} ${panel_2007_url} ${panel_2008_url} ${panel_2009_url} ${panel_2010_url} ${panel_2011_url} ${panel_2012_url} ${panel_2013_url} ${panel_2014_url} ${panel_2015_url}  ${panel_2016_url} ${panel_2017_url} ${panel_2018_url} ${panel_2019_url} ${panel_2020_url} ${panel_2021_url} ${panel_2022_url})
declare -a panel_url_list=(${panel_2018_url} ${panel_2019_url} ${panel_2020_url} ${panel_2021_url} ${panel_2022_url} ${panel_2023_url})
...
while getopts "asptlFh" OPTION; do
        case ${OPTION} in
                ...
                h)
                        ...
                        echo "   -t 	download all Transittal Sheet files 2018 through 2023"
                        echo "   -p 	download all Panel files 2018 through 2023"
                        echo "   -l 	download all LAR files 2018 through 2023"
                        echo "   -s     download specific file using name format:"
                        echo " 	  p for panel, t for transmittal sheet and l for LAR"
                        echo " 	  and a four digit number indicating the desired year, such as 2018."
                        echo " 	  example: panel_2018 for the 2018 panel file, lar_2018 for the 2018 LAR file"
                        echo "    or ts_2018 for the 2018 Transmittal Sheet file"
...
if [ $# -eq 0 ]; then
    ...
    YEAR=2018 #set start year to 2004, this code does not support downloads prior to 2004
